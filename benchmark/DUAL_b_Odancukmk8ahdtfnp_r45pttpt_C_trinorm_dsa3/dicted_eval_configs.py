...
def dan_mjst_dict_eval_cfg(
        save_root, dsroot,
        log_path, iterkey, temeta=None, maxT=30):
    if (log_path):
    ...
    task_dict = {}
    task_dict = arm_base_mk8_task_default(task_dict, "base_mjst_", osdanmk8_eval_routine_cfg, 25,
                                          te_meta_path_mjst, None, log_path)
