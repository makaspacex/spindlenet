...
from neko_2020nocr.dan.dan_modules_pami.neko_xtra_fe_xl import NekoCCOFeatureExtractorThicc
...
def get_cco_thicc(arg_dict, path, optim_path=None):
    ...
    return get_default_model(NekoCCOFeatureExtractorThicc, args, path, arg_dict["with_optim"], optim_path)
