from neko_sdk.ocr_modules.neko_prototyper_gen2.neko_label_sampler import NekoPrototypeSamplerBasic
...
def get_meta_holder(arg_dict, path, optim_path=None):
    ...
    return get_default_model(NekoPrototypeSamplerBasic, adict, path, arg_dict["with_optim"], optim_path)
