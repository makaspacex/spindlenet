...
from neko_2021_mjt.dss_presets.quickviet import get_dss_quickviet
...
def model_mod_cfg(tr_meta_path_chs, maxT_viet):
    ...
    mods = arm_trinorm_mk8hnp_module_set_dan_r45_magic(mods, "base_viet_", maxT_viet, capacity, feat_ch,
                                                       tr_meta_path_chs, ccnt=62, wemb=0)
    return mods
...
def dan_single_model_train_cfg(save_root, dsroot,
    ...
    maxT_viet = 30
    # load it here
    tr_meta_path_viet, te_meta_path_viet, train_joint_ds, viet_eval_ds = get_dss_quickviet(dsroot, maxT_viet, maxT_viet,
                                                                                           bsize)
    task_dict = {}
    task_dict = arm_base_mk8_task_default(task_dict, "base_viet_", osdanmk8_eval_routine_cfg, maxT_viet,
                                          te_meta_path_viet, viet_eval_ds,
