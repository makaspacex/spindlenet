from neko_2021_mjt.modulars.dan.ctxmodules.v2s import NekoBasicCtxModule
...
def get_ctxmodule(arg_dict, path, optim_path=None):
    ...
    return get_default_model(NekoBasicCtxModule, adict, path, arg_dict["with_optim"], optim_path)
