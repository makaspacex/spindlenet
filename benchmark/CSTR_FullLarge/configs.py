...
def dan_single_model_train_cfg(save_root, dsroot,
    ...
    task_dict = {}
    task_dict = arm_base_mk8_task_default(task_dict, "base_mjst_", osdanmk8_eval_routine_cfg, maxT_mjst,
                                          te_meta_path_mjst, mjst_eval_ds, log_path, force_skip_ctx=False)
