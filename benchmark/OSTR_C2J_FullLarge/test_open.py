...
from data_root import find_export_root, find_model_root, find_data_root
...
def get_tester(temeta):
    ...
    if (len(sys.argv) < 2):
        argv = ["Meeeeooooowwww",
                find_export_root() + "//OSTR_C2J_FullLarge/jtrmodels",
                "_E0",
                find_model_root() + "//OSTR_C2J_FullLarge/jtrmodels",
                ]
    else:
        argv = sys.argv
