...
def osdanmk8_ocr_routine(sampler_name, prototyper_name, semantic_branch_name, feature_extractor_name, seq_name,
                         TA_name, pred_name, ctxmodule_name, loss_name, ctxloss_name, label_name, image_name, mask_name,
                         log_path, log_each, name, maxT):
    return \
        {
...
def osdanmk8a_ocr_routine(sampler_name, prototyper_name, semantic_branch_name, feature_extractor_name, seq_name,
                          TA_name, pred_name, ctxmodule_name, loss_name, ctxloss_name, label_name, image_name,
                          mask_name, log_path, log_each, name, maxT):
    return \
        {
...
def osdanmk8_eval_routine_cfg(sampler_name, prototyper_name, semantic_branch_name, feature_extractor_name,
                              TA_name, seq_name, pred_name, ctxmodule_name, loss_name, image_name, label_name,
                              mask_name, log_path, name, maxT, measure_rej=False):
    return \
        {
            "name": name,
            "maxT": maxT,
