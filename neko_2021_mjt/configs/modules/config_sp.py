from neko_2021_mjt.modulars.dan.decoupled_prototyper_system import NekoPrototyperSp
...
def get_sp_prototyper(arg_dict, path, optim_path=None):
    ...
    return get_default_model(NekoPrototyperSp, adict, path, arg_dict["with_optim"], optim_path)
