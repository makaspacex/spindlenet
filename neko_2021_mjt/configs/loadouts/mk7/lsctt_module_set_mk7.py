...
from neko_2021_mjt.configs.modules.config_fe_db import config_fe_r45_binorm_layernorm
from neko_2021_mjt.configs.modules.config_fe_db import config_fe_r45_binorm_wo_norm
...
def arm_module_set_r45trinorm_orig_dsa3hGTAnp_mk7_wide_64_layernorm(prefix, maxT, capacity, feat_ch, tr_meta_path, srcdst=None, expf=1, fecnt=3, wemb=0.3, cam_ch=64):
    ...
    srcdst["feature_extractor_container"] = config_fe_r45_binorm_layernorm (3, feat_ch, cnt=fecnt,ch_overid_num=ch_overid_num)
    srcdst["feature_extractor_cco"] = config_bogo_resbinorm("feature_extractor_container", "res1")
    srcdst["feature_extractor_proto"] = config_bogo_resbinorm("feature_extractor_container", "res2")
    srcdst["GA"] = config_sa_mk3(feat_ch=ch_overid_num[1])
    srcdst["TA"] = config_cam_stop(maxT, feat_ch=feat_ch, scales=[
...
def arm_module_set_r45trinorm_orig_dsa3hGTAnp_mk7_wo_norm(prefix, maxT, capacity, feat_ch, tr_meta_path, srcdst=None, expf=1, fecnt=3, wemb=0.3, cam_ch=64):
    ...
    srcdst["feature_extractor_container"] = config_fe_r45_binorm_wo_norm (3, feat_ch, cnt=fecnt,ch_overid_num=ch_overid_num)
    srcdst["feature_extractor_cco"] = config_bogo_resbinorm("feature_extractor_container", "res1")
    srcdst["feature_extractor_proto"] = config_bogo_resbinorm("feature_extractor_container", "res2")
    srcdst["GA"] = config_sa_mk3(feat_ch=ch_overid_num[1])
    srcdst["TA"] = config_cam_stop(maxT, feat_ch=feat_ch, scales=[
