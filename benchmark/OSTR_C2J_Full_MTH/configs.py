...
def model_mod_cfg(tr_meta_path_chs, tr_meta_path_mjst, maxT_mjst, maxT_chs):
    ...
    feat_ch = 512
    mods = {}
    # mods=arm_trinorm_mk8hnp_module_set_dan_r45(mods,"base_mjst_",maxT_mjst,capacity,feat_ch,tr_meta_path_mjst,ccnt=38,wemb=0)
...
def dan_single_model_train_cfg(save_root, dsroot, log_path, log_each, itrk="Top Nep", bsize=48, tvitr=200000):
    ...
    task_dict = arm_base_mk8_task_default(task_dict, "base_chs_", osdanmk8_eval_routine_cfg, maxT_chs,
                                          te_meta_path_chsjap, chs_eval_ds,
                                          log_path, force_skip_ctx=True)

    routines = {}
    # routines = arm_base_mk8_routine(routines, "base_mjst_", osdanmk8a_ocr_routine, maxT_mjst, log_path,
    #                                  log_each, "dan_mjst_", view_name="synthw", proto_viewname="glyph")
    routines = arm_base_mk8_routine(routines, "base_chs_", osdanmk8adt_ocr_routine, maxT_chs, log_path, log_each,
                                    "dan_chs_", view_name="synthw", proto_viewname="glyph")
