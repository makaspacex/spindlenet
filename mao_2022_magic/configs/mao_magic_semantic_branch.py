from mao_2022_magic.modulars.mao_magic_semantic_branch import MaoMagicSemanticModule
...
def get_mao_magic_ctxmodule(arg_dict, path, optim_path=None):
    ...
    return get_default_model(MaoMagicSemanticModule, adict, path, arg_dict["with_optim"], optim_path)
