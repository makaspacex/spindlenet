...
if __name__ == '__main__':
    ...
    for i in ["500", "1000", "1500", "2000"]:
        ...
        if (len(sys.argv) < 2):
            argv = ["Meeeeooooowwww",
                    None,  # find_export_root()+"DUAL_chhw_Odancukmk8ahdtfnp_r45_C_trinorm_dsa3/jtrmodels"+i+"/",
                    "_E4",
                    find_model_root() + "DUAL_chhw_Odancukmk8ahdtfnp_r45_C_trinorm_dsa3/jtrmodels" + i + "/",
                    ]
        else:
            argv = sys.argv
