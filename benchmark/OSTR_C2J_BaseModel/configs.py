...
def dan_single_model_train_cfg(save_root, dsroot,
    ...
    task_dict = arm_base_task_default2(task_dict, "base_chs_", osdanmk7_eval_routine_cfg, maxT_chs, te_meta_path_chsjap,
                                       chs_eval_ds,
                                       log_path)
    ...
    #                             log_each, "dan_mjst_")
    routines = arm_base_routine2(routines, "base_chs_", osdanmk7_ocr_routine, maxT_chs, log_path,
                                 log_each, "dan_chs_")
