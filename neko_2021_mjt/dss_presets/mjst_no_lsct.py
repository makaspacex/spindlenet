...
from neko_2021_mjt.configs.data.chs_jap_data import get_chs_tr_meta64, get_jap_te_meta64
...
def get_dss(dsroot, maxT_mjst, maxT_chs, bsize, random_aug=True):
    ...
    train_joint_ds = get_dataloadercfgs(dsroot, te_meta_path_mjst, tr_meta_path_mjst, maxT_mjst, maxT_chs, bsize,
                                        random_aug)
