...
def dan_single_model_train_cfg(save_root, dsroot, chcnt,
    ...
    task_dict = {}
    task_dict = arm_base_mk8_task_default(task_dict, "base_hwdb_", osdanmk8_eval_routine_cfg, 1, te_meta_path_hwdb,
                                          hwdb_eval_ds, log_path, force_skip_ctx=True, view_name="synthw",
                                          proto_viewname="glyph")
